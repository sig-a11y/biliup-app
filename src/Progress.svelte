...
<div class="flex items-center justify-center space-x-2 px-1">
    <div class="parent-svg flex-none w-12 items-center justify-center">
        ...
        <!--    </svg>-->
        <!--{:else }-->
        <svg aria-hidden="true" class="del animate-bounce m-auto h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"
        ...
        <!-- TODO: remove this hack. 使用真正的按钮+让删除按钮始终显示 -->
        <button on:click={remove} aria-label="删除文件">
        <svg class="svg m-auto h-7 w-7" fill="currentColor"
